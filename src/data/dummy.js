...
export const COMPANY_DETAILS = {
  ...
  6: {
    ...
    whitelist: [
      { dept: 'システム統括本部',     contacted: true,  jobAcquired: true  },
      { dept: 'Lumada事業部',         contacted: true,  jobAcquired: true  },
      { dept: 'デジタルエンジニアリング部', contacted: true, jobAcquired: true },
      { dept: '人財統括本部',         contacted: true,  jobAcquired: true  },
      { dept: 'クラウドサービス部',   contacted: true,  jobAcquired: false },
      { dept: 'AI&データサイエンス部', contacted: false, jobAcquired: false },
      { dept: 'グローバルソリューション部', contacted: false, jobAcquired: false },
    ],
    deals: [
  ...
  7: {
    ...
    whitelist: [
      { dept: 'プロダクト開発本部',   contacted: true,  jobAcquired: true  },
      { dept: 'SaaS事業推進部',       contacted: true,  jobAcquired: true  },
      { dept: '人事企画部',           contacted: true,  jobAcquired: true  },
      { dept: 'データサイエンス部',   contacted: true,  jobAcquired: false },
      { dept: 'インフラ運用部',       contacted: false, jobAcquired: false },
    ],
    deals: [
  ...
  8: {
    ...
    whitelist: [
      { dept: 'コマース開発本部',     contacted: true,  jobAcquired: true  },
      { dept: 'フィンテック事業部',   contacted: true,  jobAcquired: true  },
      { dept: 'モバイル事業部',       contacted: true,  jobAcquired: true  },
      { dept: 'AI推進室',             contacted: true,  jobAcquired: false },
      { dept: 'グローバル開発部',     contacted: false, jobAcquired: false },
      { dept: '人事本部',             contacted: true,  jobAcquired: true  },
    ],
    deals: [
  ...
  9: {
    ...
    whitelist: [
      { dept: 'ネットワーク技術本部',       contacted: true,  jobAcquired: true  },
      { dept: '5G/6G推進室',                contacted: true,  jobAcquired: true  },
      { dept: 'DX推進本部',                 contacted: true,  jobAcquired: true  },
      { dept: 'プラットフォーム開発部',     contacted: true,  jobAcquired: false },
      { dept: 'セキュリティ統括部',         contacted: true,  jobAcquired: false },
      { dept: 'グローバル事業企画部',       contacted: false, jobAcquired: false },
    ],
    deals: [
  ...
  10: {
    ...
    whitelist: [
      { dept: 'R&D本部',               contacted: true,  jobAcquired: true  },
      { dept: 'ゲーム&ネットワークサービス部', contacted: true, jobAcquired: true },
      { dept: '半導体事業部',           contacted: true,  jobAcquired: true  },
      { dept: '人事部',                 contacted: true,  jobAcquired: true  },
      { dept: 'AIロボティクス研究所',   contacted: true,  jobAcquired: false },
      { dept: 'エンタテインメント本部', contacted: false, jobAcquired: false },
    ],
    deals: [
